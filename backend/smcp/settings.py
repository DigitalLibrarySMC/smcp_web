"""
Django settings for smcp project.
...
SECRET_KEY = 'django-insecure-*y)n*!j)uohdz(k3#9=cjr#td+)!6tx&en2$i9lk)=wka3gy5b'
...
WSGI_APPLICATION = 'smcp.wsgi.application'
...
VONAGE_API_KEY = '157ce4b5'
VONAGE_API_SECRET = 'vvTfDrWlqla8ZNFy'
